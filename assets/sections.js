...
import { timeline } from "//trendywardrob.com/cdn/shop/t/14/assets/vendor.min.js?v=114992621884149252901712243288";
import { EffectCarousel } from "//trendywardrob.com/cdn/shop/t/14/assets/theme.js?529";
...
import { timeline as timeline2, inView } from "//trendywardrob.com/cdn/shop/t/14/assets/vendor.min.js?v=114992621884149252901712243288";
...
import { Delegate } from "//trendywardrob.com/cdn/shop/t/14/assets/vendor.min.js?v=114992621884149252901712243288";
...
import { animate, timeline as timeline3, stagger, Delegate as Delegate2 } from "//trendywardrob.com/cdn/shop/t/14/assets/vendor.min.js?v=114992621884149252901712243288";
import { AnimatedDetails, EffectCarousel as EffectCarousel2, Drawer, throttle } from "//trendywardrob.com/cdn/shop/t/14/assets/theme.js?529";
...
import { animate as motionAnimate, scroll } from "//trendywardrob.com/cdn/shop/t/14/assets/vendor.min.js?v=114992621884149252901712243288";
...
import { scroll as scroll2, timeline as timeline4, animate as animate2, inView as inView2 } from "//trendywardrob.com/cdn/shop/t/14/assets/vendor.min.js?v=114992621884149252901712243288";
import { imageLoaded, getHeadingKeyframe } from "//trendywardrob.com/cdn/shop/t/14/assets/theme.js?529";
...
import { ScrollArea } from "//trendywardrob.com/cdn/shop/t/14/assets/theme.js?529";
...
import { animate as animate3, timeline as timeline5, inView as inView3 } from "//trendywardrob.com/cdn/shop/t/14/assets/vendor.min.js?v=114992621884149252901712243288";
import { getHeadingKeyframe as getHeadingKeyframe2, throttle as throttle2 } from "//trendywardrob.com/cdn/shop/t/14/assets/theme.js?529";
...
import { animate as animate4, inView as inView4 } from "//trendywardrob.com/cdn/shop/t/14/assets/vendor.min.js?v=114992621884149252901712243288";
...
import { timeline as timeline6, inView as inView5 } from "//trendywardrob.com/cdn/shop/t/14/assets/vendor.min.js?v=114992621884149252901712243288";
...
import { animate as animate5, timeline as timeline7, inView as inView6 } from "//trendywardrob.com/cdn/shop/t/14/assets/vendor.min.js?v=114992621884149252901712243288";
import { imageLoaded as imageLoaded2 } from "//trendywardrob.com/cdn/shop/t/14/assets/theme.js?529";
...
import { timeline as timeline8, animate as animate6, stagger as stagger2, inView as inView7 } from "//trendywardrob.com/cdn/shop/t/14/assets/vendor.min.js?v=114992621884149252901712243288";
import { EffectCarousel as EffectCarousel3, imageLoaded as imageLoaded3, getHeadingKeyframe as getHeadingKeyframe3 } from "//trendywardrob.com/cdn/shop/t/14/assets/theme.js?529";
...
import { Drawer as Drawer2 } from "//trendywardrob.com/cdn/shop/t/14/assets/theme.js?529";
...
import { timeline as timeline9, animate as animate7, inView as inView8 } from "//trendywardrob.com/cdn/shop/t/14/assets/vendor.min.js?v=114992621884149252901712243288";
import { EffectCarousel as EffectCarousel4 } from "//trendywardrob.com/cdn/shop/t/14/assets/theme.js?529";
...
import { extractSectionId } from "//trendywardrob.com/cdn/shop/t/14/assets/theme.js?529";
...
import { scroll as scroll3, timeline as timeline10, ScrollOffset, inView as inView9 } from "//trendywardrob.com/cdn/shop/t/14/assets/vendor.min.js?v=114992621884149252901712243288";
...
import { animate as animate8, scroll as scroll4 } from "//trendywardrob.com/cdn/shop/t/14/assets/vendor.min.js?v=114992621884149252901712243288";
...
import { animate as motionAnimate2, timeline as timeline11, inView as inView10 } from "//trendywardrob.com/cdn/shop/t/14/assets/vendor.min.js?v=114992621884149252901712243288";
import { EffectCarousel as EffectCarousel5, imageLoaded as imageLoaded4, getHeadingKeyframe as getHeadingKeyframe4 } from "//trendywardrob.com/cdn/shop/t/14/assets/theme.js?529";
...
var SlideshowCarousel = class extends EffectCarousel5 {
      ...
      this._player.addEventListener("player:start", (event) => {
        ...
        circles.forEach((item) => {
          ...
          if (item.getAttribute("aria-current") === "true") {
            motionAnimate2(circle, { strokeDasharray: [`0px, ${circle.getTotalLength()}px`, `${circle.getTotalLength()}px, ${circle.getTotalLength()}px`] }, { duration: event.detail.duration, easing: "linear" });
          } else {
  ...
  _onSlideSelected(event) {
    ...
    if (event.detail.slide.getAttribute("data-slide-type") === "video") {
      ...
      this._player?.setDuration(visibleVideo.querySelector("video").duration);
    } else {
